...
// include paths adapted to this source tree (2 differing lines against the upstream version).
// Upstream: register_interface (https://github.com/pulp-platform/register_interface), src/reg_cut.sv at tag v0.4.1
