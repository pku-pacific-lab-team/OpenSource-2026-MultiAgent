...
// adapted for the PKU_2602 SoC integration (719 differing lines against the upstream version; see the file inventory in THIRD_PARTY.md at the repository root).
// Upstream: axi (https://github.com/pulp-platform/axi), src/axi_intf.sv at tag v0.39.3
