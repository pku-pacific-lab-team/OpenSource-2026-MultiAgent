...
// Upstream: cva6 (https://github.com/openhwgroup/cva6), core/cache_subsystem/wt_dcache_ctrl.sv at tag v5.0.0
  ...
  always_comb begin
    ...
    for (int unsigned k = 0; k < CVA6Cfg.NrCachedRegionRules; k++) begin
      pass[k] = config_pkg::range_check(
        ...
        {{{64-DCACHE_TAG_WIDTH-DCACHE_INDEX_WIDTH}{1'b0}}, address_tag_q, {DCACHE_INDEX_WIDTH{1'b0}}}           // Address to check
      );
    end
    is_cacheable = |pass;
  end
