...
//
// Modified by the PKU_2602 project team (School of Integrated Circuits, Peking University), last changed 2026-01-05:
// include paths adapted to this source tree; assertion includes removed (3 differing lines against the upstream version).
// Upstream: serial_link (https://github.com/pulp-platform/serial_link), src/slink_link_layer.sv at tag v2.0.0
