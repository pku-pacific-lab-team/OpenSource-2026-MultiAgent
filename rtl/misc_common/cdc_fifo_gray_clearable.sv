...
// assertion includes removed (4 differing lines against the upstream version).
// Upstream: common_cells (https://github.com/pulp-platform/common_cells), src/cdc_fifo_gray_clearable.sv at tag v1.32.0
