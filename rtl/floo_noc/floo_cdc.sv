...
// include paths adapted to this source tree; assertion includes removed (6 differing lines against the upstream version).
// Upstream: FlooNoC (https://github.com/pulp-platform/FlooNoC), hw/floo_cdc.sv at tag v0.6.0
