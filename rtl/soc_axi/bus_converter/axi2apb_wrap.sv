...
// adapted for the PKU_2602 SoC integration (57 differing lines against the upstream version; see the file inventory in THIRD_PARTY.md at the repository root).
// Upstream: axi2apb (https://github.com/pulp-platform/axi2apb), src/axi2apb_wrap.sv at tag v0.1.0
