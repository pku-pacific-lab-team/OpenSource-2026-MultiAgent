...
//
// Modified by the PKU_2602 project team (School of Integrated Circuits, Peking University), last changed 2026-01-06:
// adapted for the PKU_2602 SoC integration (106 differing lines against the upstream version; see the file inventory in THIRD_PARTY.md at the repository root).
// Upstream: serial_link (https://github.com/pulp-platform/serial_link), src/slink.sv at tag v2.0.0
...
#(
  ...
  parameter bit NoRegCdc          = 1'b1,// Set as 1 for the same control and data clcok
  ...
  assign hw2reg.raw_mode_in_data.rd_data._reserved_31_4 = '0;
  ...
  if (EnChAlloc) begin : gen_channel_alloc_regs
    ...
    // assign hw2reg.channel_alloc_tx_ctrl.rd_ack =
    //     reg2hw.channel_alloc_tx_ctrl.req
    //   & ~reg2hw.channel_alloc_tx_ctrl.req_is_wr;
    // assign hw2reg.channel_alloc_tx_ctrl.rd_data = '0;
    //////////////////////////////////////////////////////
    ...
    // Added by Gemini-3-Pro /////////////////////////////
    // assign hw2reg.channel_alloc_rx_ctrl.rd_ack =
    //     reg2hw.channel_alloc_rx_ctrl.req
    //   & ~reg2hw.channel_alloc_rx_ctrl.req_is_wr;
    // assign hw2reg.channel_alloc_rx_ctrl.rd_data = '0;
    //////////////////////////////////////////////////////
