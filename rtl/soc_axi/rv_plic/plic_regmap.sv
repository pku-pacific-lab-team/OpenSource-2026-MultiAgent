...
// minor local edits (1 differing lines against the upstream version).
// Upstream: rv_plic (https://github.com/pulp-platform/rv_plic), rtl/plic_regmap.sv at branch master
