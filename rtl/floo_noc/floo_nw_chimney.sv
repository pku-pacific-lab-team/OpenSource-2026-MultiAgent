...
// adapted for the PKU_2602 SoC integration (63 differing lines against the upstream version; see the file inventory in THIRD_PARTY.md at the repository root).
// Upstream: FlooNoC (https://github.com/pulp-platform/FlooNoC), hw/floo_nw_chimney.sv at tag v0.6.0
