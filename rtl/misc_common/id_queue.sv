...
// minor local edits (10 differing lines against the upstream version).
// Upstream: common_cells (https://github.com/pulp-platform/common_cells), src/id_queue.sv at tag v1.32.0
