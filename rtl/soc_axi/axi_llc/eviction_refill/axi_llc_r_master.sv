...
// minor local edits (2 differing lines against the upstream version).
// Upstream: axi_llc (https://github.com/pulp-platform/axi_llc), src/eviction_refill/axi_llc_r_master.sv at tag v0.2.2
