...
// adapted for the PKU_2602 SoC integration (30 differing lines against the upstream version; see the file inventory in THIRD_PARTY.md at the repository root).
// Upstream: FlooNoC (https://github.com/pulp-platform/FlooNoC), hw/floo_axi_chimney.sv at tag v0.6.0
...
module floo_axi_chimney #(
  ...
  input  sam_rule_t [RouteCfg.NumSamRules-1:0] sam_map_i
);
