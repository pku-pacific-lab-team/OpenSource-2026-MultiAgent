...
// include paths adapted to this source tree; assertion includes removed (9 differing lines against the upstream version).
// Upstream: FlooNoC (https://github.com/pulp-platform/FlooNoC), hw/vc_router_util/floo_input_fifo.sv at tag v0.6.0
