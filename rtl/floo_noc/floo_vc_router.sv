...
//
// Modified by the PKU_2602 project team (School of Integrated Circuits, Peking University), last changed 2025-12-30:
// adapted for the PKU_2602 SoC integration (12 differing lines against the upstream version; see the file inventory in THIRD_PARTY.md at the repository root).
// Upstream: FlooNoC (https://github.com/pulp-platform/FlooNoC), hw/floo_vc_router.sv at tag v0.6.0
