...
// include paths adapted to this source tree; assertion includes removed (4 differing lines against the upstream version).
// Upstream: FlooNoC (https://github.com/pulp-platform/FlooNoC), hw/floo_simple_rob.sv at tag v0.6.0
