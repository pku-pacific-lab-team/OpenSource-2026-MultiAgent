...
//
// Modified by the PKU_2602 project team (School of Integrated Circuits, Peking University), last changed 2025-12-11:
// minor local edits (2 differing lines against the upstream version).
// Upstream: iDMA (https://github.com/pulp-platform/iDMA), src/backend/idma_dataflow_element.sv at tag v0.6.5
