...
// include paths adapted to this source tree (4 differing lines against the upstream version).
// Upstream: register_interface (https://github.com/pulp-platform/register_interface), src/axi_lite_to_reg.sv at tag v0.4.1
