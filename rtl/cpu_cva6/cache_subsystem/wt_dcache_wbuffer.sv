...
// adapted for the PKU_2602 SoC integration (224 differing lines against the upstream version; see the file inventory in THIRD_PARTY.md at the repository root).
// Upstream: cva6 (https://github.com/openhwgroup/cva6), core/cache_subsystem/wt_dcache_wbuffer.sv at tag v5.0.0
...
#(
    ...
    input [config_pkg::NrMaxRules-1:0][63:0] CachedRegionAddrBase_i      // runtime configurable, added by: Hongou Li [Peking University]
);
  ...
  // Manually inline the logic of is_inside_cacheable_regions
  logic is_cacheable;
  always_comb begin
    logic [config_pkg::NrMaxRules-1:0] pass;
    pass = '0;
    // Loop bound MUST come from the static CVA6Cfg parameter for synthesis
    for (int unsigned k = 0; k < CVA6Cfg.NrCachedRegionRules; k++) begin
      pass[k] = config_pkg::range_check(
        CachedRegionAddrBase_i[k],                  // Use the runtime signal for base address
        CVA6Cfg.CachedRegionLength[k],              // Use the static parameter for length
        {{64 - DCACHE_TAG_WIDTH - DCACHE_INDEX_WIDTH{1'b0}}, miss_tag, {DCACHE_INDEX_WIDTH{1'b0}}}          // Address to check
      );
    end
    is_cacheable = |pass;
  end
  ...
  assign miss_nc_o = !cache_en_i || !is_cacheable;
  ////////////////////////////////////////////////////////////////////////////////////////
