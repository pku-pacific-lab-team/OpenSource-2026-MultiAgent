...
// adapted for the PKU_2602 SoC integration (73 differing lines against the upstream version; see the file inventory in THIRD_PARTY.md at the repository root).
// Upstream: cva6 (https://github.com/openhwgroup/cva6), core/frontend/bht.sv at tag v5.0.0
