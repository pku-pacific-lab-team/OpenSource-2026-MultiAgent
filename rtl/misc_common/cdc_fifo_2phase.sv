...
// minor local edits (6 differing lines against the upstream version).
// Upstream: common_cells (https://github.com/pulp-platform/common_cells), src/cdc_fifo_2phase.sv at tag v1.32.0
