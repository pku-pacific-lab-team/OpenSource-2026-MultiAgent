...
// assertion includes removed (8 differing lines against the upstream version).
// Upstream: common_cells (https://github.com/pulp-platform/common_cells), src/multiaddr_decode.sv at tag v1.32.0
