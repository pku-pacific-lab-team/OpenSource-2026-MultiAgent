...
// adapted for the PKU_2602 SoC integration (41 differing lines against the upstream version; see the file inventory in THIRD_PARTY.md at the repository root).
// Upstream: cva6 (https://github.com/openhwgroup/cva6), core/mmu_sv32/cva6_shared_tlb_sv32.sv at tag v5.0.0
...
#(
  ...
  function automatic logic [SHARED_TLB_WAYS-1:0] shared_tlb_way_bin2oh(input logic [$clog2(SHARED_TLB_WAYS
)-1:0] in);
