...
//
// Modified by the PKU_2602 project team (School of Integrated Circuits, Peking University), last changed 2026-01-10:
// adapted for the PKU_2602 SoC integration (93 differing lines against the upstream version; see the file inventory in THIRD_PARTY.md at the repository root).
// Upstream: serial_link (https://github.com/pulp-platform/serial_link), src/slink_phys_layer.sv at tag v2.0.0
...
module slink_phys_layer #(
  ...
  ////////////////////////////////////////////////////////////////////////////
  // Changed by: Mingxuan Li <siris-lmx@stu.pku.edu.cn> [Peking University] //
  logic ddr_rcv_clk;
  ...
  tc_clk_buffer ddr_rcv_clk_buffer_inst (
    .clk_i ( ddr_rcv_clk   ),
    .clk_o ( ddr_rcv_clk_o )
  );
  // always_ff @(posedge clk_i, negedge rst_ni) begin
  ...
  //////////////////////////////////////////////////////////////////////////
  // Added by: Mingxuan Li <siris-lmx@stu.pku.edu.cn> [Peking University] //
  logic clk_slow_buf;
  tc_clk_buffer clk_slow_buffer_inst (
    .clk_i ( clk_slow     ),
    .clk_o ( clk_slow_buf )
  );
  //////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////
  // Changed by: Mingxuan Li <siris-lmx@stu.pku.edu.cn> [Peking University] //
  `FF(data_out_q, data_out_i, '0, clk_slow_buf, rst_ni)
