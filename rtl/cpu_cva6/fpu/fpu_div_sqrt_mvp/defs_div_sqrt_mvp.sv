...
//
// Local modifications: see the notices in this file (last changed 2026-01-09).
// Upstream: fpu_div_sqrt_mvp (https://github.com/pulp-platform/fpu_div_sqrt_mvp), hdl/defs_div_sqrt_mvp.sv at tag v1.0.1
...
package defs_div_sqrt_mvp;
   ...
   // simplify the combinational logic by reducing iteration unit number options
   localparam Iteration_unit_num_S  = 2'b01;
