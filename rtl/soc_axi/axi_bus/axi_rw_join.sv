...
// include paths adapted to this source tree; assertion includes removed (8 differing lines against the upstream version).
// Upstream: axi (https://github.com/pulp-platform/axi), src/axi_rw_join.sv at tag v0.39.3
